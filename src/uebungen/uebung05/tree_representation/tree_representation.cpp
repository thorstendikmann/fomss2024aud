...
int main()
{
    ...
    {
        fom::AuD::AVLTree<int> tree(50);

        tree.balancedInsert(44);
        std::cout << tree.traverseBFS() << std::endl;
        std::cout << tree.toGraphViz() << std::endl;
        tree.balancedInsert(63);
        std::cout << tree.traverseBFS() << std::endl;
        std::cout << tree.toGraphViz() << std::endl;
        tree.balancedInsert(10);
        std::cout << tree.traverseBFS() << std::endl;
        std::cout << tree.toGraphViz() << std::endl;
        tree.balancedInsert(70);
        std::cout << tree.traverseBFS() << std::endl;
        std::cout << tree.toGraphViz() << std::endl;
        tree.balancedInsert(55);
        std::cout << tree.traverseBFS() << std::endl;
        std::cout << tree.toGraphViz() << std::endl;
        tree.balancedInsert(14);
        std::cout << tree.traverseBFS() << std::endl;
        std::cout << tree.toGraphViz() << std::endl;
        tree.balancedInsert(11);
        std::cout << tree.traverseBFS() << std::endl;
        std::cout << tree.toGraphViz() << std::endl;
        tree.balancedInsert(16);
        std::cout << tree.traverseBFS() << std::endl;
        std::cout << tree.toGraphViz() << std::endl;
        tree.balancedInsert(52);
        std::cout << tree.traverseBFS() << std::endl;
        std::cout << tree.toGraphViz() << std::endl;
        tree.balancedInsert(95);
        std::cout << tree.traverseBFS() << std::endl;
        std::cout << tree.toGraphViz() << std::endl;
        tree.balancedInsert(61);
        std::cout << tree.traverseBFS() << std::endl;
        std::cout << tree.toGraphViz() << std::endl;
        tree.balancedInsert(99);
        std::cout << tree.traverseBFS() << std::endl;
        std::cout << tree.toGraphViz() << std::endl;
        tree.balancedInsert(12);
        std::cout << tree.traverseBFS() << std::endl;
        std::cout << tree.toGraphViz() << std::endl;
    }
}
